...
id_amigo INT AUTO_INCREMENT NOT NULL PRIMARY KEY,
amigo VARCHAR(30) not null,
fk_amigo INT NOT NULL,
FOREIGN KEY (fk_amigo) references Tbl_Usuario (id_usuario));

INSERT INTO TBL_AMIGOS
VALUES (null, 'Getulio', 3);
...
SELECT *
FROM tbl_usuario
FULL JOIN tbl_amigos
ON id_usuario = fk_amigo
ORDER BY Nome;
